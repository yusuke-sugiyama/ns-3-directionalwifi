...
def register_Ns3DcfManager_methods(root_module, cls):
    ...
    cls.add_method('NotifyNavResetNow', 
                   'void', 
                   [param('ns3::Time', 'duration')])
    ## dcf-manager.h (module 'wifi'): void ns3::DcfManager::NotifyNavStartNow(ns3::Time duration, int mode) [member function]
    cls.add_method('NotifyNavStartNow', 
                   'void', 
                   [param('ns3::Time', 'duration'), param('int', 'mode')])
...
def register_Ns3DcfState_methods(root_module, cls):
    ...
    cls.add_method('DoNotifyInternalCollision', 
                   ...
                   [], 
                   is_pure_virtual=True, visibility='private', is_virtual=True)
    ## dcf-manager.h (module 'wifi'): void ns3::DcfState::DoNotifyNextTransmission(DcfManager* manager) [member function]
    cls.add_method('DoNotifyNextTransmission', 
                   'void', 
                   [param('DcfManager*', 'manager')], 
                   is_pure_virtual=True, visibility='private', is_virtual=True)
...
def register_Ns3MacLowDcfListener_methods(root_module, cls):
    ...
    cls.add_method('NavReset', 
                   ...
                   [param('ns3::Time', 'duration')], 
                   is_pure_virtual=True, is_virtual=True)
    ## mac-low.h (module 'wifi'): void ns3::MacLowDcfListener::NavStart(ns3::Time duration, int mode) [member function]
